...
//     std::cout << std::fixed << std::setprecision(4); // Format output with 4 decimal places
//     for (int row = 0; row < 4; ++row) {
//         std::cout << "[ ";
//         for (int col = 0; col < 4; ++col) {
//             std::cout << std::setw(8) << matrix[col][row] << " "; // Access elements column-major
//         }
//         std::cout << "]" << std::endl;
//     }
//     std::cout << std::endl;
...
//     // ----------------------------
//     Shader shader("../shaders/vertex_text.glsl", "../shaders/fragment_text.glsl");
